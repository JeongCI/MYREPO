...
public class BookDaoTest implements LoggerManger {
	...
	public BookDaoTest() {
		dao = new BookDao();
		book01 = new Book("9791163031222_001", "Do it! 지옥에서 온 문서 관리자 깃&깃허브 입문_001", "이고잉 고경희_001", "소프트웨어 공학",
				"2019-12-06", true);
		book02 = new Book("9791163031222_002", "Do it! 지옥에서 온 문서 관리자 깃&깃허브 입문_002", "이고잉 고경희_002", "소프트웨어 공학",
				"2019-12-06", true);
		book03 = new Book("9791163031222_003", "Do it! 지옥에서 온 문서 관리자 깃&깃허브 입문_003", "이고잉 고경희_003", "소프트웨어 공학",
				"2019-12-06", false);
...
//		main.doRetrieve();
		...
		do {
			...
			inCommand = inCommand.trim(); // 양쪽 공백, 대문자로 변화

			Book book = null;
			String[] dataArr = null;
			String readData = ""; // commnad 입력 데이터
			...
			case "U": // 수정
				System.out.println("수정 : 9791163031222_003,Do it! 지옥에서 온 문서 관리자 깃&깃허브 입문_003_U,이고잉 고경희_003_U,소프트웨어 공학,2019-12-06,0>>");
			...
			case "AS": // 목록조회
				...
				System.out.println("----------------------------------------------------------");
				System.out.println("\t도서번호\t\t\t제목\t\t\t저자\t\t\t장르\t\t\t출판일\t\t\t대충가능 여부");
				System.out.println("----------------------------------------------------------");
				String delim = "\t";
