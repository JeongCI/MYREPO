...
<!-- eUtil String, number, date-->
<script src="${CP_RES}/js/eUtil.js" ></script>

<!-- page -->
<script src="${CP_RES}/js/jquery_bootpag.js" ></script>
...
<script>
  $(document).ready(function(){
    ...
    //다건 삭제: 화면에서 회원ID를 전달, List<String>회원ID, Service.upDeleteAll(List<String>)
    //예외처리:O
    //ID중복체크:O
...
<body>
     ...
     <!-- 페이징 -->
     <div class="test-center col-sm-12 col-md-12 col-lg-12">
     ...
     <div class="form-group">
       ...
       <div class="col-sm-1 col-md-1 col-lg-1">
         <input type="button" class="btn btn-primary btn-sm" value ="중복확인" id="idCheck">
       </div>
