...
<script >
  ...
  $(document).ready(function(){
     ...
     //ExcelDownload
     $("#doExcelDown").on("click",function(){
       console.log("doExcelDown");
       let method = "POST";
       let url    = "${CP}/user/doExcelDown.do";
       let async  = true;
       let header = "NO,아이디,이름,등급,이메일,들록일"
       let headerWidth = "1,1,2,2,3,1";
       let headerAlign = "c,c,l,l,c,l";
       
       console.log("url: "+url);
       
       let frm = document.userFrm;
       frm.searchDiv.value = $("#searchDiv").val();
       frm.searchWord.value = $("#searchWord").val();
       frm.pageSize.value = $("#pageSize").val();
       frm.pageNo.value = "1";
       frm.header.value = header;
       frm.headerWidth.value = headerWidth;
       frm.align.value = headerAlign;
       frm.action = url;
...
<body>
  ...
  <div class="container">   
    ...
    <form action="#" method="POST" name="userFrm" id="userFrm" class="form-inline text-right">
      <input type="hidden" name="pageNo" id="pageNo">
      <input type="hidden" name="header" id="header">
      <input type="hidden" name="headerWidth" id="headerWidth">
      <input type="hidden" name="align" id="align">
      <div class="form-group">
        ...
        <!------------------------------------- 버튼 -->
          ...
          <input type="button" class="btn btn-primary btn-sm" value="Excel" id="doExcelDown">
