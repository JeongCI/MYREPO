...
public class JWebUserDao {
	...
	public void setUp() throws Exception {
		...
		LOG.debug("==============================");
		userVO1 = new UserVO("p11_01", "이상무11_01", "4321",Level.BASIC,1,0,"jci1203@naver.com","날짜_사용하지 않음");
		userVO2 = new UserVO("p11_02", "이상무11_02", "4321",Level.SILVER,50,2,"jci1203@naver.com","날짜_사용하지 않음");
		userVO3 = new UserVO("p11_03", "이상무11_03", "4321",Level.GOLD,100,31,"jci1203@naver.com","날짜_사용하지 않음");
		userVO4 = new UserVO("p11_04", "이상무11_04", "4321",Level.SILVER,50,2,"jci1203@naver.com","날짜_사용하지 않음");
		userVO5 = new UserVO("p11_05", "이상무11_05", "4321",Level.GOLD,100,31,"jci1203@naver.com","날짜_사용하지 않음");
        //데이터 검색용
		search  = new UserVO("p11", "이상무11_05", "4321",Level.GOLD,100,31,"jci1203@naver.com","날짜_사용하지 않음");
		//페이지+검색
		searchVO  = new SearchVO(10,1,"10","p1","");
	}
