...
public class JUserServiceTest {
	...
	public void add() throws SQLException {
		...
		//4. Level null -> BASIC
		UserVO userWithOutLevelGet =  dao.doSelectOne(userWithOutLevel);
		assertEquals(userWithOutLevelGet.getLevel(), Level.BASIC);
		//Level GOLD -> GOLD
		UserVO userWithLevelGet =  dao.doSelectOne(userWithLevel);
	...
	public void allOrNothing() throws SQLException {
		...
		//testUserService.setDataSource(dataSource); //datasource 수동 주입
